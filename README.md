...
* [bundlex](https://github.com/membraneframework/bundlex) - Multi-platform tool for compiling C code along with elixir projects, for use in NIFs and CNodes. The tool provides also convenient way of accessing compiled code in elixir modules.
...
* [membrane_protocol_sdp](https://github.com/membraneframework/membrane_protocol_sdp) - Parser for Session Description Protocol.
* [SMPPEX](https://github.com/savonarola/smppex) - SMPP 3.4 protocol and framework implementation in Elixir.
* [membrane_protocol_rtsp](https://github.com/membraneframework/membrane_protocol_rtsp) - Client for Realtime Transfer Streaming Protocol.
...
* [Membrane Framework](https://www.membraneframework.org) - Membrane Framework provides support in development of multimedia processing applications.
